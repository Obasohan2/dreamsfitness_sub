"""
Django settings for dreamsfitness project.
...
ALLOWED_HOSTS = [
    ...
    'localhost',  # listen to stripe webhooks
    'dreamsfitness-f17a7a33b0ee.herokuapp.com',  # heroku app
    ]
...
ROOT_URLCONF = 'dreamsfitness.urls'
...
WSGI_APPLICATION = 'dreamsfitness.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'dreamsfitness'  # change this to your AWS bucket name
