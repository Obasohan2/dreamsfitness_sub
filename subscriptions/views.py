...
#         discount = None
#         if discount_id:
#             discount = get_object_or_404(PlanDiscount, pk=discount_id, subplan=plan)
...
#                 total_price * (discount.total_discount / Decimal("100"))
#             )

#         # Store subscription in session, to be used in cart + checkout
#         request.session["subscription_cart"] = {
#             "plan_id": plan.id,
#             "months": months,
#             "discount_id": discount.id if discount else None,
...
#         # Choose where to send them next: cart or checkout
